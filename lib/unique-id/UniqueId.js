...
class UniqueId {
     ...
     *  A 2-byte random value generated once per process. This random value is unique to the machine and process.
     *  A 2-byte incrementing counter, initialized to a random value.
     * @param {*} time number of seconds that have elapsed since January 1, 1970 (midnight UTC/GMT)
     ...
     * @param {*} time number of seconds that have elapsed since January 1, 1970 (midnight UTC/GMT), if left blank, it uses current time
